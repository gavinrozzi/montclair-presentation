...
description = "A webinar by Gavin Rozzi and the Montclair University Center for Cooperative Media"
outputs = ["Reveal"]
[reveal_hugo]
theme = "league"
margin = 0.2
...
![The OPRAmachine website](/img/OM.JPG)
...
![A sample response notification](/img/newresponse.JPG)
...
### ![Partially Successful](/img/status/successful@2x.png) Successful
### ![Successful](/img/status/partiallysuccessful@2x.png) Partially Successful
### ![Gone Postal](/img/status/postal@2x.png) Gone Postal
---

## More request states
### ![Delivery Error](/img/status/delivery_error@2x.png) Delivery Error
### ![Not Held](/img/status/notheld@2x.png) Info Not Held
### ![Refused](/img/status/refused@2x.png) Refused
### ![Overdue](/img/status/overdue@2x.png) Long Overdue
...
![Advanced Search](img/advsearch.JPG)
...
![OPRAmachine Pro Logo](img/ompro.png)
...
![Populating a website with OPRA request data is easy](img/gr-opras.JPG)
